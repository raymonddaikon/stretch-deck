...
<div
	class={cn(
		'flex w-full flex-wrap place-items-center justify-end gap-0.5 rounded-md py-2 pr-2 selection:bg-primary disabled:opacity-50 aria-disabled:cursor-not-allowed',
		className
	)}
